...
//const real dp = 0.001; //initial particle distance
const real dp = 0.0025;
...
const real dt = 0.009; //time step (initial time step)
...
const real kappa = 384.1;
const real cp = 385;
//const real kappa = 16062;
//const real cp = 4500;
const real T0 = 0;
...
const unsigned int step_end = 10001; //Endtime in steps;

const unsigned int save_output_interval = 500; //Interval to save results
const unsigned int save_output_interval_interpolated = 5000; //Interval to save interpolated results

// ========== SIMULATION CONTROL ========== //

//Case directory
std::string casePATH = "/mnt/c/Users/ondre/Documents/DP/tinySPH-master/cases/heatSolid/";
